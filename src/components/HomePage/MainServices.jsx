...
const ServiceSections = () => {
  return (
    <section className="py-12 px-4 sm:px-6 lg:px-8 flex justify-center">
      <motion.div
        className="w-full max-w-6xl p-6 sm:p-8 lg:p-10 rounded-3xl bg-gray-50 shadow-neumorphic space-y-12"
      ...
      >
        ...
        >
          <h2 className="text-3xl sm:text-4xl font-bold text-blue-800">Services We Offer</h2>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <div className="image-wrapper w-full lg:w-1/2 aspect-[4/3] rounded-xl overflow-hidden">
            <motion.img
              src={execImg}
          ...
          <div className="content-wrapper w-full lg:w-1/2 space-y-4 px-4 sm:px-6">
            <motion.h2 className="service-title text-2xl sm:text-3xl" variants={fadeVariant}>Executive Search</motion.h2>
            <motion.h3 className="service-subtitle text-lg sm:text-xl" variants={fadeVariant}>Leadership that Transforms Your Business</motion.h3>
            <motion.p className="service-text text-gray-600" variants={fadeVariant}>
        ...
        <motion.div
          className="flex flex-col lg:flex-row-reverse items-center gap-6 lg:gap-10"
          id="section-emiratisation"
          variants={fadeVariant}
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true }}
        >
          ...
          <div className="content-wrapper w-full lg:w-1/2 space-y-4 px-4 sm:px-6">
            <motion.h2 className="service-title text-2xl sm:text-3xl" variants={fadeVariant}>Emiratisation</motion.h2>
            <motion.h3 className="service-subtitle text-lg sm:text-xl" variants={fadeVariant}>Empowering the UAE Workforce, One Placement at a Time</motion.h3>
            <motion.p className="service-text text-gray-600" variants={fadeVariant}>
        ...
        >
          ...
          <div className="content-wrapper w-full lg:w-1/2 space-y-4 px-4 sm:px-6">
            <motion.h2 className="service-title text-2xl sm:text-3xl" variants={fadeVariant}>Contractual Staffing</motion.h2>
            <motion.h3 className="service-subtitle text-lg sm:text-xl" variants={fadeVariant}>Scalable and Cost-Effective Workforce Solutions</motion.h3>
            <motion.p className="service-text text-gray-600" variants={fadeVariant}>
