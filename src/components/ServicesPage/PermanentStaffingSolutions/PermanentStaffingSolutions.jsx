      ...
      <main className="PermanenStaffingSolutionsMain px-4 py-10 w-full mx-auto space-y-16">
        ...
        <section className="w-full py-8 px-4 sm:px-6 lg:px-8 bg-white">
          <div className="max-w-7xl mx-auto space-y-8">
            <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-blue-700 text-center">
              Why Choose Permanent Staffing?
            </h2>
            <div className="flex flex-col lg:flex-row items-center gap-6 lg:gap-8">
              <div className="w-full lg:w-1/2 space-y-4 text-gray-700">
                <p className="text-sm sm:text-base md:text-lg ChoosePermanentPMP">
        ...
        <section>
          <h2 className="PermanentStaffingSolutionsHeading text-center text-2xl font-medium">
